 ...
 * Scraper controller.
 *
 * @Route("/schedulerruntime")
 */
class SchedulerruntimeController extends Controller
{

    /**
     * @Route(
     *      "/",
     *      name="balancenet_scrapy_schedulerruntime_index",
     *      requirements={"_format"="html|json"},
     *      defaults={"_format" = "html"}
     * )
     * @AclAncestor("balancenet_scrapy_schedulerruntime_view")
     * @Template
     */
     ...
     * Create user form
     *
     * @Route("/create", name="balancenet_scrapy_schedulerruntime_create")
     * @Template("BalancenetScrapyBundle:Schedulerruntime:update.html.twig")
     * @Acl(
